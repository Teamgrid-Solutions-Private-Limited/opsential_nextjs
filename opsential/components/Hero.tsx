    ...
    <section className="relative pt-36 pb-24 md:pt-48 md:pb-36 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          {/* Badge */}
          <div className="pill text-accent border-accent/20 bg-accent-soft mb-6">
          ...
          {/* Headline */}
          <h1
            className="text-4xl sm:text-5xl md:text-[3.5rem] font-extrabold tracking-[-0.035em] leading-[1.08] mb-6"
            dangerouslySetInnerHTML={{ __html: data.hero_title }}
          />
 
          {/* Subline */}
          <p className="text-lg md:text-xl text-[#9ca3af] leading-relaxed mb-10 max-w-2xl mx-auto">
            {data.hero_subtitle}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              className="bg-accent hover:bg-accent-h text-white font-bold rounded-full px-8 py-3.5 transition-colors duration-200 text-center text-[15px]"
            ...
            <a
              ...
              className="bg-transparent hover:bg-surface text-[#ededef] border border-[rgba(255,255,255,0.10)] hover:border-[rgba(255,255,255,0.16)] rounded-full px-8 py-3.5 font-semibold transition-all duration-200 text-center text-[15px]"
        ...
        <div className="relative max-w-5xl mx-auto">
          <div className="card overflow-hidden rounded-[20px]">
            ...
            <div className="h-[420px] overflow-hidden"></div>
          </div>
        </div>
      </div>
    </section>
